...
from mrf_swarm.costs.base_costs import DimensionSumCost
...
def make_costs(c_pos=0., c_vel=0.25, c_u=0.2, c_term=6., c_obs=50, obs_avoid_dist=.3,
               ...
               signed_dist_map_fn: SignedDistanceMap2DCost = None, use_terminal_cost=True,
    ...
    if(use_terminal_cost):
        ...
        return (obs_cost_fn, running_cost_fn, bounds_cost_fn)


def make_terminal_costs(c_term=6.,
               ctrl_space='acc', dim=2, goal=None,
               tensor_kwargs={"device": "cpu", "dtype": torch.float}):
    """Utility function for creating the costs for the point swarm problem."""
